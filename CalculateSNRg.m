    ...
    for tIndex = 1:Nseg
        ...
        for i = M:N
            ...
            if (mod(tIndex, i) == 0)
                ...
                if (i == 1)
                    noiseDSContribution1 = [noiseDSContribution1, [abs(grouper_noise(i-M+1, 1))^2; abs(grouper_noise(i, floor(nNoiseSample/2)))^2; abs(grouper_noise(i, end))^2]];
                elseif (i == 2)
                    noiseDSContribution2 = [noiseDSContribution2, [abs(grouper_noise(i-M+1, 1))^2; abs(grouper_noise(i, floor(nNoiseSample/2)))^2; abs(grouper_noise(i, end))^2]];
                elseif (i == 3)
                    noiseDSContribution3 = [noiseDSContribution3, [abs(grouper_noise(i, 1))^2; abs(grouper_noise(i, floor(nNoiseSample/2)))^2; abs(grouper_noise(i, end))^2]];
                elseif (i == 4)
                    noiseDSContribution4 = [noiseDSContribution4, [abs(grouper_noise(i, 1))^2; abs(grouper_noise(i, floor(nNoiseSample/2)))^2; abs(grouper_noise(i, end))^2]];
                end
